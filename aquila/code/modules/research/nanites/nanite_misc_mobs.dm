/*borowiki z bee skasowały kompletnie funkcje różnego punch dmg dla simple moba z powodu ,,a" numer commit #5648 w #1720
 więc teraz swarm ma tyle hp co mob pszczoła, na udawanie dawnej funkcji bo tak samo tam zrobili, tak samo też działa bez teg var -sandmann */
...
/mob/living/simple_animal/hostile/nanophage/Initialize(mapload)
	...
	addtimer(CALLBACK(src, PROC_REF(death)), 20 SECONDS) //z 15 sekund na aktywnosc 20 sekund
...
/mob/living/simple_animal/hostile/nanophage/death(gibbed)
