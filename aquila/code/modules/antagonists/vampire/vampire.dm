...
/datum/antagonist/vampire/greet()
	...
	owner.current.playsound_local(get_turf(owner.current), 'aquila/sound/ambience/antag/vampire.ogg',80,0)
...
/datum/antagonist/vampire/proc/handle_bloodsucking(mob/living/carbon/human/H)
	...
	while(do_mob(O, H, 50))
		...
		playsound(O.loc, 'sound/items/eatfood.ogg', 40, 1, extrarange = -4)//have to be within 3 tiles to hear the suckin
