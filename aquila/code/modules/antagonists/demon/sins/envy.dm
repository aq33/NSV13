...
/obj/item/melee/touch_attack/envy/afterattack(atom/target, mob/living/carbon/human/user, proximity_flag, click_parameters)
	...
	if(M.anti_magic_check())
		to_chat(user, "<span class='warning'[M] resists your unholy jealousy!</span>")
		to_chat(M, "<span class='warning'A creeping feeling of jealousy dances around your mind before being suddenly dispelled.</span>")
		..()
		return
	...
	if(ishuman(target))
		...
		if(user.real_name != H.dna.real_name)
			...
			"<span class='boldannounce'[H.p_they(TRUE)] think[H.p_s()] [H.p_theyre()] <i>sooo</i> much better than you. Not anymore, [H.p_they()] won't.")
		return ..()
