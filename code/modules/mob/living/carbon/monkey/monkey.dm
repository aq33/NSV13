...
/datum/species/teratoma
	...
	inherent_traits = list(TRAIT_NOHUNGER, TRAIT_RADIMMUNE, TRAIT_BADDNA, TRAIT_NOGUNS, TRAIT_NONECRODISEASE, TRAIT_NOTHIRST)	//Made of mutated cells // AQ EDIT - TRAIT_NOTHIRST
