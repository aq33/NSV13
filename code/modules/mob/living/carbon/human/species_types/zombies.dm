...
/datum/species/zombie
	...
	TRAIT_LIMBATTACHMENT,TRAIT_NOBREATH,TRAIT_NODEATH,TRAIT_FAKEDEATH,TRAIT_NOCLONELOSS, TRAIT_NOTHIRST, TRAIT_NOSHITTING) // AQ - added TRAIT_NOSHITTING, TRAIT_NOTHIRST
