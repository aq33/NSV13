...
/datum/blobstrain/reagent/electromagnetic_web
	...
	description = "zadajesz ciężkie poparzenia oraz wytwarzasz impulsy EMP przy atakowani."
	...
	analyzerdesceffect = "IJest podatny na wszystkie typy obrażeń, jak również otrzymuje ogromne obrażenia od źródeł fizycznych. Dodatkowo wytwarza mały impuls EMP przy śmierci."
