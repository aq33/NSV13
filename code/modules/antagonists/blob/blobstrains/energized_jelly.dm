...
/datum/blobstrain/reagent/energized_jelly
	...
	analyzerdescdamage = "Jego ataki powodują wyczerpanie oraz wysokie obrażenia od niedotlenienia. Dodatkowo powoduje, że osoby zaatakowane na krótką chwilę tracą możliwość oddychani."
