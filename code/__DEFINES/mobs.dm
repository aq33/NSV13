...
#define THIRST_LEVEL_TURGID 600
#define THIRST_LEVEL_HYDRATED 550
#define THIRST_LEVEL_SLAKED 450
#define THIRST_LEVEL_THIRSTY 350
#define THIRST_LEVEL_DEHYDRATED 250
...
// AQ EDIT
//Used as an upper limit for species that continuously gain thirst
#define THIRST_LEVEL_ALMOST_FULL 535
